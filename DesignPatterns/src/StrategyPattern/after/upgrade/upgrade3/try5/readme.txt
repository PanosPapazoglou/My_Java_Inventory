 ...
 *  
 *  
 * New Spec 3: "Setting Behavior Dynamically" - Ayto pou tha prepei na mporei na ginei tora einai na allazei i simperifora Dinamika 
 * Solution 1: 1.Tha prosthesoume 2 nees methodous stin Duck class :  
 *                    setFlyBehavior(FlyBehavior fb) kai tin
 *                  setQuackBehavior(QuackBehavior qb)
 *             2.Tha ftiaxoume ena neo DuckType(ModelDuck.java)
 *             3.Tha ftiaxoume ena neo FlyBehavior type (FlyRocketPowered.java)
 *             4.Tha alalxoume tin test class , prosthetontas to ModelDuck kai kanontas to rocket-enabled sto runtime 
 *     
 *  -----------------------------------------------------------------------------------------------------------------------------------
 *
 *
