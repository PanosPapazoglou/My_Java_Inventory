package com.examples.java.Java.Language.Fundamentals.Basic.Threads;
...
// Otan ena antikeimeno p.x to new CreateThreadRunnableExample()  ( sto "..public static void main.." ) 
// tou opoiou i klasi kanei implement to Runnable Interface
// xrisimopoieite os target gia tin dimiourgia enos thread t  ( sto "..public static void main.." ) 

// tote kanontas start to thread (prosoxi ena thread ginetai start oxi kata tin dimiourgia tou alla me tin entoli.. t.start(); )
// tote EKTELEITE KAI O KODIKAS tis methodou run tou antikeimenou mas  (CreateThreadRunnableExample) se xexiristo thread!!
