package com.examples.java.Java.Language.Fundamentals.Basic.For.Loop;
...
public static void main(String[] args) {
	...
	// Ayto to kanoume gia na epanalambanete sinexeia...kai na tsekaroume sinexeia...gia palindromikous arithmous..
	for(;;){
